...
inline uint8_t SBGC_cmd_control_ext_send(SBGC_cmd_control_ext_t *p, SBGC_Parser_t *parser) {
	SerialCommand_t cmd;
...
inline uint8_t SBGC_cmd_servo_out_send(SBGC_cmd_servo_out_t *p, SBGC_Parser_t *parser) {
	SerialCommand_t cmd;
